...
extension Explanation {
    static let mockCenturyAuthoredSamples: [String: Explanation] = Dictionary(
        uniqueKeysWithValues: (MockCenturyQuestionData.silverSpecs + MockCenturyQuestionData.goldSpecs).map { spec in
