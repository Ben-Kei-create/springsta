...
extension Explanation {
    static let silverSprintAuthoredSamples: [String: Explanation] = Dictionary(
        uniqueKeysWithValues: (SilverSprintQuestionData.practiceSpecs + SilverSprintQuestionData.mockSpecs).map { spec in
